...
const identity = surface(
  ...
  [
    ...
    text('org_name', 'Maintained by', 'The organisation named in the copyright line, and read out by screen readers for its mark in the footer.'),
    text('org_url', 'Their website', 'The address the organisation\'s mark in the footer links to.'),
    { name: 'org_logo', label: 'Their mark', kind: 'image', required: false, group: 'essential', image: { store: 'repo', dir: '/brand' }, hint: 'The logo shown under "Maintained by" in the footer, the larger of the two marks. An SVG or a PNG with a transparent background looks best.' },
    ...
    text('builder_name', 'Builder', 'The builder\'s name, read out by screen readers for its mark in the footer.'),
    text('builder_url', 'Their website', 'The address the builder\'s mark links to.'),
    { name: 'builder_logo', label: 'Their mark', kind: 'image', required: false, group: 'essential', image: { store: 'repo', dir: '/brand' }, hint: 'The logo shown under the builder credit in the footer, the smaller of the two marks.' },
