...
thinker_mentions:
  - thinker: jawaharlal-nehru
    role: mention
    reasoning: Nehru is cited as the ultimate political patron whose personal accessibility was exploited by unqualified candidates — illustrating the corruption of the electorate by patronage politics.
    evidence:
      - quote: "His only claim was that he could see Pandit Nehru at any time of the day without a formal engagement for an interview!"
        context: "The candidate's boasted access to Nehru is used to satirise the patronage-driven rather than merit-driven selection of political representatives"
    key_passages: []
related_thinkers: 
  - jawaharlal-nehru
