---
id: "homi-mody-free-enterprise-foreign-exchange"
title: "Homi Mody: Free Enterprise & Foreign Exchange"
pubDate: "2022-06-15T07:22:32Z"
themes:
  - "economic-planning"
  - "fiscal-policy"
  - "free-enterprise"
...
pull_quote: I had also expressed my apprehensions with regard to the imposition of penal taxation, widening controls and consumption curbs, which were calculated to cause considerable hardship to every section of the people.
...
thinker_mentions:
  - thinker: abraham-lincoln
    role: mention
    reasoning: "Mody closes his case against creeping state encroachment by invoking Lincoln's dictum on the legitimate scope of government — borrowed as a liberal authority to limit the State to what citizens cannot do for themselves."
    evidence:
      - quote: it may be profitable to recall a dictum of Abraham Lincoln
        context: Mody summons Lincoln as the closing authority for his argument against unlimited State power
    key_passages: []
related_thinkers: 
  - abraham-lincoln
