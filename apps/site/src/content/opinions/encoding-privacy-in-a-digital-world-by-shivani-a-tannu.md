...
By Shivani A Tannu (Third Prize Winner, Indian Liberals Essay Contest 2019)
...
Privacy can have various meanings based on different context. It is important to understand the concepts of Privacy according to their context. Privacy has been identified with 3 broad types, s_patial privacy (related to physical spaces and things), _decisional privacy_ (related to certain significant decisions)_ and _informational privacy_ (related to personal information). Data protection is related to informational privacy. With ubiquitous nature of technology, the impact of data protection can also be seen on spatial and decisional privacy too.
...
While GDPR is not an act but guidelines that can be used to draft legislation by member nations, yet it is fruitful to compare the broad contours of GDPR with the relevant Indian law, Data Protection Bill. The major points of difference between the two are- 
...
Data privacy is a legal right and existing data protection framework in India under the IT Act is largely inadequate, in terms of implementation, protections and remedies and it lacks basic protections such as provisions for data breach notifications[v]. Therefore, India urgently needs to enact a dedicated data protection law.
...
[ii] Njordlaw.com. _Three reasons why we need strict data protection regulations_. Retrieved from  [https://www.njordlaw.com/three-reasons-need-strict-data-protection-regulations/](https://www.njordlaw.com/three-reasons-need-strict-data-protection-regulations/)

[iii] Information-age.com. _Getting Value from your data under GDPR_. Retrieved from [https://www.information-age.com/data-under-gdpr-123476524/](https://www.information-age.com/data-under-gdpr-123476524/)

[iv] Iapp.org. _Can we balance data protection with value creation._ Retrieved from [https://iapp.org/news/a/can-we-balance-data-protection-with-value-creation/](https://iapp.org/news/a/can-we-balance-data-protection-with-value-creation/)

[v] Nipfp.org.in _Data localisation in India: Questioning the means and ends. (2018). _Retrieved from [https://www.nipfp.org.in/media/medialibrary/2018/10/WP_2018_242.pdf](https://www.nipfp.org.in/media/medialibrary/2018/10/WP_2018_242.pdf)

Author: Shivani Tannu, a Chartered Accountant from Pune. I am currently pursuing an MBA at IIM Bangalore. I have previously worked at Accenture as a Financial Analyst and now interning at Citi, securities and markets. Besides finance and law, I have a keen interest in the process of policy making, I have taken part in various youth parliament sessions before. My hobbies include trekking and reading.
