---
id: young-asians-call-to-freedom
title:
  main: "Freedom Writers: Young Asians' Call to Freedom"
  subtitle: Celebrating the Fifth Anniversary of the Young Liberals and Democrats of Asia
work_type: edited_volume
authors: []
editors: []
contributors:
  - role: other
    thinker_unresolved: Jan-Argy Tolentino
    toc_index: 1
  - role: foreword
    thinker: siegfried-herzog
    toc_index: 2
  - role: introduction
    thinker_unresolved: Neric Accosta
    toc_index: 4
  - role: author
    thinker_unresolved: Wendi Boxx
    toc_index: 5
  - role: author
    thinker_unresolved: Arvin Ello
    toc_index: 6
  - role: author
    thinker_unresolved: Renu Pokharna
    toc_index: 7
  - role: introduction
    thinker_unresolved: Mu Sochua
    toc_index: 8
  - role: author
    thinker_unresolved: Patrick Alcantara
    toc_index: 9
  - role: author
    thinker_unresolved: Ong Khang Woon
    toc_index: 10
  - role: author
    thinker_unresolved: Dashell Yancha
    toc_index: 11
  - role: introduction
    thinker_unresolved: Yim Sovann
    toc_index: 12
  - role: author
    thinker_unresolved: Pokpong Lawansiri
    toc_index: 13
  - role: author
    thinker_unresolved: Vanessa Remoquillo
    toc_index: 14
  - role: author
    thinker_unresolved: Mark Visda
    toc_index: 15
related_thinkers: []
publication:
  language: en
  publisher_name: Published exclusively by Young Liberals and Democrats of Asia (YLDA), 7B Amorsolo St., San Lorenzo Village, Makati City, Philippines. With the support of Taiwan Foundation For Democracy (TFD) and Friedrich Naumann Foundation for Liberty (FNF)
  place: Makati City, Philippines
  year: 2008
provenance:
  source: ccs_archive
  scan_quality: unknown
pdf_url: https://pub-f1430c20cc1c400da542453c56d614c8.r2.dev/other-publications/young-asians-call-to-freedom.pdf
cover_image: "https://pub-f1430c20cc1c400da542453c56d614c8.r2.dev/covers/young-asians-call-to-freedom.webp"
rights:
...
physical:
  ...
  format: Paperback anniversary anthology; includes caricatures
