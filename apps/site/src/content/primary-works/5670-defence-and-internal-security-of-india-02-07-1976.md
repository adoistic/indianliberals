...
missing_metadata_flags:
  ...
  - "publication_year_not_identified"
  - "no_formal_toc"
  - "editor_not_named"
authors_resolution:
  method: vision
...
- Reproduced letters call for the release of political prisoners, removal of press censorship, and repeal of Emergency-era constitutional amendments.
- The materials describe arrests, alleged torture, raids, surveillance, restrictions on meetings, and interference with elections and political parties.
- Reports accuse Youth Congress workers and local authorities of coercive collections, intimidation, and partisan use of state power.
- The dossier highlights attacks on newspapers and publishers, including the seizure or closure of periodicals critical of the Emergency.
- Its economic critique connects inflation, unemployment, industrial decline, and reduced purchasing power with authoritarian governance and state intervention.
- The compilation engages figures including Indira Gandhi, Jayaprakash Narayan, Vinoba Bhave, Minoo Masani, Gunnar Myrdal, and Mahatma Gandhi.
