...
provenance: 
  source: "ccs_archive"
  scan_quality: "poor"
  notes: "Imported from indianli_liberals DB (id=20, lang=Gujarati). Original PDF filename: PDF_20_6cxu3wJan-April2009 year 3, issue 1-2.pdf. OCR pages in DB: 68. OCR quality flag: corrupted. Author (per DB): Khoj."
themes: []
ai_key_points: []
paragraph_ids: []
manifestations: []
...
needs_review: true
draft: false
pdf_staging_path: "PDFs-by-publisher/gujarati/khoj-january-april-2009.pdf"
