---
id: "yodha-shetkari-by-vijay-prulkar"
title: 
...
ai_key_points:
  ...
  - "The existing site stub records the work as a 111-page Marathi book by Vijay Prulkar imported from the indianli_liberals legacy database (id=52) with 'partial' OCR quality."
  - "Because the rendered pages belong to a different book, no content-level claims, themes, or arguments from 'Yodha Shetkari' itself can be extracted on this pass."
  - "Manual action required: locate the correct PDF (original DB filename was 'PDF_52_gjn5yeYodha Shetkari.pdf') and update inventory.json before re-running extraction, or mark the entry as PDF-missing."
paragraph_ids: []
manifestations: []
language: "mr"
