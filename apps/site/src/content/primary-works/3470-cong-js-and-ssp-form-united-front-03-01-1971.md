---
id: 3470-cong-js-and-ssp-form-united-front-03-01-1971
title:
  main: "Cong (O), JS and SSP form united front; Swatantra walks out"
  subtitle: ""
work_type: essay
authors: []
editors: []
...
pdf_url: https://archive.indianliberals.in/swatantra-party-papers/3470-cong-js-and-ssp-form-united-front-03-01-1971.pdf
rights:
...
- The alliance depended on agreement over a common programme and seat adjustments.
- Minoo Masani said Swatantra had withdrawn after the Congress (O) altered its position at the last minute.
- The report presents the proposed front as both an anti-Congress coalition and a contested attempt to consolidate opposition forces.
- Further negotiations involved Atal Bihari Vajpayee, Raj Narain, Charan Singh, Morarji Desai and other opposition leaders.
- The continuation describes disagreements over adding parties and over whether a formal association with the Jana Sangh was acceptable.
- A separate clipping reports higher inventory-sales ratios among government companies than among private-sector companies.
