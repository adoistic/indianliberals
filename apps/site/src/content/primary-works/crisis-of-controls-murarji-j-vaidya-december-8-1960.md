...
pdf_url: https://pub-f1430c20cc1c400da542453c56d614c8.r2.dev/forum-of-free-enterprise/crisis-of-controls-murarji-j-vaidya-december-8-1960.pdf
cover_image: "https://pub-f1430c20cc1c400da542453c56d614c8.r2.dev/covers/crisis-of-controls-murarji-j-vaidya-december-8-1960.webp"
rights:
...
thinker_mentions:
  - thinker: friedrich-hayek
    role: mention
    reasoning: "Vaidya invokes Hayek's dictum that economic control is control over the means for all human ends to provide the theoretical foundation for his argument that India's pervasive peacetime controls corrode both liberty and development."
    evidence:
      - quote: "The essay draws on Hayek (\"economic control is the control of the means for all our ends\") and Hilaire Belloc to argue that economic controls inevitably compound, demoralise citizenry, and corrode liberty."
        context: "theoretical grounding for Vaidya's central thesis that controls are not merely inefficient but incompatible with a free society"
    key_passages: []
  - thinker: ludwig-erhard
    role: mention
    reasoning: "Vaidya cites Ludwig Erhard's West German reform — where abolishing foreign-exchange controls caused shortages to vanish almost overnight — as the empirical proof of concept that dismantling controls releases productive energy rather than causing chaos."
    evidence:
