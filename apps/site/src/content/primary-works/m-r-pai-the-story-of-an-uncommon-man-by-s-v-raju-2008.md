---
id: m-r-pai-the-story-of-an-uncommon-man-by-s-v-raju-2008
title:
  main: M. R. Pai
  subtitle: The Story of an Uncommon Common Man
work_type: book
authors:
  - s-v-raju
editors: []
contributors:
  - role: foreword
    thinker_unresolved: Ajay Piramal
related_thinkers:
  - mahatma-gandhi
publication:
  language: en
  publisher_name: M.R. Pai Foundation, Mumbai
  place: Mumbai
  year: 2008
  edition: Second edition (M.R. Pai Foundation, July 2011); first published 2008 by Strand Book Stall, Mumbai
provenance:
  source: ccs_archive
...
physical:
  ...
  format: Paperback biography; this edition sponsored by Punjab and Maharashtra Cooperative Bank Ltd for free distribution
