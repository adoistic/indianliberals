---
id: 363-changing-circumstances-and-bharatiya-jana-sangh
title:
  main: "Changing Circumstances and Bharatiya Jana Sangh"
  subtitle: ""
work_type: pamphlet
authors: []
editors: []
...
publication:
  language: en
  publisher_name: "Deepak Prakashan, New Delhi 1."
  place: "New Delhi 1."
provenance:
  source: ccs_archive
  scan_quality: good
...
- Madhok interprets the Congress split as the outcome of both leadership rivalries and ideological conflict.
- Jawaharlal Nehru is criticised for internationalism, socialism, and policies that Madhok associates with economic stagnation and vulnerability on Tibet and national security.
- Vallabhbhai Patel is presented as a contrasting nationalist figure committed to more truthful financial policies and a firmer external outlook.
- The pamphlet argues that Jana Sangh should cooperate with other nationalist and democratic parties rather than remain isolated.
- Madhok defends competitive economic activity and private producers while opposing state monopoly and indiscriminate nationalisation.
- The organisation is urged to combine social change with democratic and peaceful methods, tolerance, and freedom of thought.
- Jana Sangh's nationalist and Hindu cultural identity is described as central to its political distinctiveness, while the text rejects the principle of two separate countries.
