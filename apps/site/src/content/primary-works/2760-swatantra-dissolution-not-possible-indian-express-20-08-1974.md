...
pdf_url: https://archive.indianliberals.in/swatantra-party-papers/2760-swatantra-dissolution-not-possible-indian-express-20-08-1974.pdf
cover_image: "https://archive.indianliberals.in/covers/2760-swatantra-dissolution-not-possible-indian-express-20-08-1974.webp"
rights:
...
missing_metadata_flags:
  ...
  - "no_named_author"
  - "document_comprises_mixed_material"
authors_resolution:
  method: vision
  confidence: medium
  proposed_unknowns: []
...
- A Madras Civil Court judge reportedly held that judicially restraining the party’s dissolution was not possible at that stage.
- The Maharashtra State Council opposed dissolving the Swatantra Party to facilitate the formation of a new party.
- The resolution maintains that the party’s principles and policies remain valid.
- It argues that a vague common programme would not create a truly national political alternative.
- It contends that the continued existence of Congress and Jan Sangh would undermine the intended benefits of a two-party system.
- The council requested that the question be reviewed before the National Convention, while pledging to preserve the party’s identity if dissolution occurred.
