---
id: minoo-shroff-on-nehru-welfare-and-indias-promise
title:
  main: Minoo Shroff on Nehru, Welfare and India's Promise
work_type: interview
authors:
- minoo-shroff
editors: []
...
youtube_url: https://www.youtube.com/watch?v=v2q2QiXK7zY
description: Minoo Shroff of the A D Shroff Memorial Trust talks about Nehru, welfare,
  entitlements and India's promise
provenance:
  source: ccs_archive
...
summary: Minoo Shroff reflects on the entitlement mindset bred by cradle-to-grave
  ...
  India's conceptual and planning abilities but laments the chronic delivery gap,
  citing Alexander Fleming's quip that India had the best 'museum' of British equipment
  but no manpower to use it. He holds up JN Tata's late nineteenth-century foresight
  in founding the Indian Institute and Tata Steel — and Jamshedpur as a working 'smart
  city' and CSR model — as proof that Indians had homegrown templates that were ignored
  in favour of leaning on the West. Comparing the Soviet collapse (heavy industry
  but no consumer goods) with India's post-liberalisation consumer boom, he credits
  the private sector with lifting growth from the Hindu rate of 3.5% to 6.5–8%, and
  defends even America's 'robber barons' as eventual philanthropists and educationists.
key_points:
- Welfare-state entitlement bred dependency that outlived the Soviet Union and still
  shapes Indian expectations of the state.
- India's weakness is delivery and capacity, not conceptualisation — planners abroad
  praised the plans but asked where the execution was.
- Alexander Fleming famously called India a 'museum of British equipment' lacking
  the manpower to operate it.
- JN Tata's founding of the Indian Institute and Tata Steel — and the model city of
  Jamshedpur — show indigenous templates for development and CSR were available all
  along.
- The Soviet Union broke down because it produced armaments and steel but no consumer
  goods; people want bread, lipsticks and clothes.
- Liberalisation lifted India from the 3.5% Hindu rate of growth to an average of
  6.5–8%, with consumer demand now reaching small towns like Nanded and Aurangabad.
- The private sector is the prime engine of growth, and even America's robber barons
  ultimately became philanthropists and educationists.
thinker_mentions:
- thinker: minoo-shroff
  role: subject
  reasoning: Minoo Shroff is the interviewee delivering the entire monologue on welfare,
    delivery and India's growth.
  evidence:
  - quote: We thought look at the welfare from cradle to grave, there was welfare.
    context: Opens the discussion of welfare-state entitlement.
  - quote: We are some of the greatest conceptualisers, our plans have been greatly
      lauded abroad, but they said, where is the delivery?
    context: States his thesis on India's planning-vs-delivery gap.
  - quote: So I think now that we have been opened up at least very substantially,
      we see the benefit from Hindu rate of growth of three and a half percent to
      an average of six and a half, seven now going aspiring for eight, eight and
      a half
    context: Credits liberalisation with the rise above the Hindu rate of growth.
  key_passages:
  - quote: This is what we are suffering from and what many people are saying that
      this entitlement business, people totally dependent on the state, and we are
      not able to deliver, our public services are not kept busy, because their mindset
      for service is not there.
    what_it_shows: 'His core diagnosis: entitlement breeds dependency and public services
      lack a service mindset.'
...
- thinker_unresolved: Jamsetji Nusserwanji Tata
  ...
  evidence:
  - quote: Look look at the foresight of JN Tata, starting an Indian Institute when
      he was looked down upon that you can't feed your people.
    context: Cites JN Tata's founding of the Indian Institute as visionary.
  - quote: That is how Tata Steel is a model of development. We talk of now smart
      cities. There is no better city.
    context: Points to Jamshedpur/Tata Steel as the original 'smart city' and CSR
      template.
  key_passages:
  - quote: And when did he think of it? In eighteen nineties, when he was totally
...
- thinker_unresolved: Alexander Fleming
  ...
  evidence:
  - quote: When Alexander Fleming, the discoverer of penicillin came here, he said,
      I find the best museum of British equipment here, I hope they deliver.
    context: Used to illustrate the gap between Indian infrastructure and capacity.
  key_passages:
  - quote: I find the best museum of British equipment here, I hope they deliver.
