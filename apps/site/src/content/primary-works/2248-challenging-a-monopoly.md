---
id: 2248-challenging-a-monopoly
title:
  main: "Challenging a Monopoly"
  subtitle: "Former AIR DG moves court to challenge Government’s radio and TV monopoly."
work_type: essay
authors: []
editors: []
contributors: []
...
pdf_url: https://archive.indianliberals.in/swatantra-party-papers/2248-challenging-a-monopoly.pdf
rights:
...
missing_metadata_flags:
  ...
  - "periodical_title_not_printed"
  - "issue_number_not_printed"
  - "no_toc"
authors_resolution:
  method: vision
  confidence: medium
...
- The petition challenges the rejection of a proposal for an independent radio and television broadcasting station for Western India.
- The article frames the refusal to license private broadcasting as a possible violation of Article 19’s guarantee of freedom of expression.
- A study commissioned by the Indian Committee for Cultural Freedom and the Indian Liberal Group reported alleged suppression, distortion, and censorship of news by the broadcasting authorities.
- The Government relied on statutory provisions and public-interest grounds involving sovereignty, security, public order, and morality.
- The article recalls earlier committee recommendations for broadcasting autonomy, including the V. G. Verghese Committee’s proposed bill.
- The courts’ consideration of Masani’s case is presented as an opportunity to establish a precedent for future legal debate over broadcasting freedom.
