---
id: 2461-a-new-political-party-comes
title:
...
missing_metadata_flags:
  ...
  - "periodical_masthead_not_visible"
  - "issue_identification_not_visible"
authors_resolution:
  method: vision
  confidence: high
  proposed_unknowns: []
...
- Masani links economic liberty to individual liberty, private enterprise, peasant proprietorship, and voluntary initiative.
- The article criticizes landholding ceilings, joint cooperative farming, state grain monopolies, licensing, taxation, and bureaucratic regulation.
- The party supports a limited role for state enterprise in heavy industry and essential public services, while opposing state control of trade and agriculture.
- Masani argues that small farmers and the urban middle class form the social base for resistance to the Congress economic programme.
- The article invokes West Germany and Japan as examples of economic expansion based on enterprise rather than restrictive planning.
- The Swatantra Party is positioned as an explicitly anti-Communist force that could break the existing Congress-versus-Communist political choice.
- Masani acknowledges that electoral success is uncertain but argues that the party's existence itself expands democratic choice.
