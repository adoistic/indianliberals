---
id: 161-must-india-go-the-vietnam-way
title:
  main: "MUST INDIA GO THE VIETNAM WAY?"
  subtitle: ""
work_type: speech
authors:
  - minoo-masani
...
publication:
  ...
  publisher_name: "PUBLISHED BY THE SWATANTRA PARTY, NEW DELHI AND PRINTED AT CHANANA PRINTING HOUSE, DELHI-6 (INDIA)"
  place: "New Delhi"
  year: 1967
provenance:
  source: ccs_archive
...
pdf_url: https://archive.indianliberals.in/swatantra-party-papers/161-must-india-go-the-vietnam-way.pdf
cover_image: "https://archive.indianliberals.in/covers/161-must-india-go-the-vietnam-way.webp"
rights:
...
- He attacks the Congress Party for repeating failed policies, expanding nationalisation and taxation, and tolerating opportunistic defections.
- He argues that the Socialist parties are too close to Congress policy to offer a reliable democratic alternative, while the Jan Sangh is vulnerable to Communist outreach.
- The Naxalbari uprising is interpreted as part of a Communist strategy involving guerrilla organisation, coercion, and cross-border support.
- Vietnam is used as a warning about the combination of guerrilla bases, foreign direction, and the absence of a broad-based democratic government.
- Masani rejects both Moscow-aligned and Peking-aligned Communist politics as threats to India’s democratic system.
- He proposes a Government of Democratic Unity joining Congress dissidents, Swatantra, Jan Sangh, and Socialist parties while excluding Communists and totalitarians.
- The speech warns that political paralysis could create the conditions for military dictatorship or another form of authoritarian rule.
