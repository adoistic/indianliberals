...
description: 'Indian jurist and liberal economist Nani A Palkhivala authored a booklet
  on the Union Budget 1992-93, wherein he critically examines India’s first Union
  Budget post the 1991 liberalisation. Nani Palkhivala uses his ability to explain
  complex and often misunderstood references and proposals by the government to the
  mass audience without extracting the essence of a historical budget! Watch this
  video to understand his take on the budget in what he calls a “watershed budget.”

  Read more: [The Union Budget 1992-93 by Nani Palkhivala](https://indianliberals.in/content/the-union-budget-1992-93/)'
provenance:
  source: ccs_archive
...
summary: 'This 2023 video commentary unpacks Nani Palkhivala''s analysis of the Union
  ...
  anchored on four thrusts: liberalisation, global integration, tax reduction, and
  a stable balance of payments. He attributed India''s post-independence poverty to
  ideological socialism, contrasting India''s stagnant per-capita income with the
  multi-fold gains of South Korea and Hong Kong over the same period.


  Palkhivala rebutted critics who claimed the budget was dictated by the World Bank
  and IMF, asserting the Indian government''s capacity to think independently after
  forty years of mistaken policy. He dismissed fears of multinationals ''swamping''
  India by noting that the world economy was no longer the era of the East India Company,
  and framed inflation worries in the context of a global recession.


  The narrator walks through the macroeconomic logic: the June 1991 balance of payments
  crisis (driven by NRI deposit withdrawals, the Iraq war oil shock, and weak exports),
  the move to partial rupee convertibility (illustrated by the Pakistani rupee''s
  appreciation against the Indian rupee after full convertibility), and the reduction
  of the Statutory Liquidity Ratio from 38.5% to 30% to free up bank credit for businesses.'
key_points:
- 'Palkhivala identified four thrusts of the 1992-93 budget: liberalisation, global
  integration, tax reduction, and a stable balance of payments.'
- He called India 'not poor by nature, but poor by policy', attributing stagnation
  to ideological socialism.
- 'Comparative benchmark: South Korea''s per-capita income grew to 13x and Hong Kong''s
  to 30x India''s, from a similar starting point.'
- Rejected the criticism that the budget was dictated by the World Bank and IMF, defending
  Indian policy autonomy.
- Dismissed multinational-swamping fears by arguing the world economy had moved past
  the East India Company era.
- Endorsed partial rupee convertibility, using the Pakistani rupee's appreciation
  post-convertibility as evidence.
- Welcomed the SLR cut from 38.5% to 30% as freeing bank capital for productive lending
  to entrepreneurs.
thinker_mentions:
- thinker: nani-palkhivala
  role: subject
  reasoning: The entire video is dedicated to explaining Palkhivala's analysis of
    the Union Budget 1992-93; he is both quoted directly and the focus of the narrator's
    exposition.
  evidence:
  - quote: Today, we are going to talk about Nani Palkhivala's take on the Union Budget
      nineteen ninety two ninety three, which was done as part of India's liberalization
      reforms.
    context: Narrator opens by naming Palkhivala as the subject.
  - quote: He called this a watershed budget, which indeed it was, and that it marked
      the beginning of a new chapter in India's economic history.
    context: Narrator summarising Palkhivala's framing.
  - quote: This country, I'm never tired of saying, is not poor by nature, but it
      is poor by policy.
    context: Palkhivala speaking directly at the opening.
  - quote: Nani Palkhivala said that he believed in the potential of this country
      and that the government was capable of thinking by itself after forty years
      of mistaken policy.
    context: Narrator paraphrasing Palkhivala's rebuttal to critics.
  - quote: Nani Palkhivala also appreciated the reduction of statutory liquidity ratio
      from 38.5% to 30% since it would allow banks to lend more to businesses and
      reduce the bank interest rate.
    context: Narrator on Palkhivala's view of SLR reform.
  key_passages:
  - quote: This country, I'm never tired of saying, is not poor by nature, but it
      is poor by policy.
    what_it_shows: Encapsulates Palkhivala's classical-liberal diagnosis of Indian
      poverty as a policy failure rather than a natural condition.
  - quote: He believed that India's poverty since independence was a result of our
      ideological socialism.
    what_it_shows: Shows Palkhivala's critique of Nehruvian socialism as the root
      cause of India's economic stagnation.
  - quote: He rebutted the fears of being swamped by the multinationals, saying that
      the entire world is not East India Company and that the emerging world economy
      was erasing the national boundaries.
    what_it_shows: Demonstrates Palkhivala's defence of global integration against
      protectionist anxieties.
  - quote: Nani Palkhivala called the partial convertibility of the rupee a sensible
      step.
    what_it_shows: Captures his endorsement of a key liberalisation measure on currency
      policy.
  - quote: Balance of trade deficit arises from the fact that we import goods worth
      33,000 crores as we did in this year, and we export goods worth 28,000 crores.
    what_it_shows: Palkhivala's concrete framing of the trade deficit problem in his
      own voice.
related_thinkers:
- nani-palkhivala
---
