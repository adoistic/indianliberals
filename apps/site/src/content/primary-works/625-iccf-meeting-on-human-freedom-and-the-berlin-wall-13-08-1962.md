---
id: 625-iccf-meeting-on-human-freedom-and-the-berlin-wall-13-08-1962
title:
  main: "ICCF Meeting on \"Human Freedom And the Berlin Wall\" at Sunderbai Hall on 13th August, 1962"
  subtitle: ""
work_type: speech
...
- The notes argue that the Wall prevents people from exercising the right to leave and return to their country.
- Changes inside Russia and in Sino-Soviet relations are acknowledged, but the underlying coercive structure is said to remain unchanged.
- Ukraine, Hungary, and East Germany are cited as examples of pressure on the Soviet leadership and its subjects.
- The Wall is presented as a barrier against people who wish to “vote with their feet,” rather than simply as a defence against enemies.
- The Universal Declaration of Human Rights, Article 13(2), is used as the document’s principal normative reference.
- The later handwritten pages broaden the file’s concerns to Indian democracy, neutrality, communism, defence, and economic development, though their connection to the typed speech is uncertain.
