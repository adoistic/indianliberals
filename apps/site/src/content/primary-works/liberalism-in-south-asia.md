---
id: liberalism-in-south-asia
title:
  main: Liberalism in South Asia
  subtitle: ""
...
contributors:
  ...
  - role: author
    ...
    toc_index: 2
  - role: author
    thinker: chanaka-amaratunga
    toc_index: 3
  - role: author
    thinker: kusum-shrestha
    toc_index: 4
  - role: author
    thinker: detmar-doering
    toc_index: 5
  - role: author
    thinker: s-v-raju
    toc_index: 6
...
publication:
  ...
  place: New Delhi
  year: 1995
  series: Liberal Times, Volume III / Number 4
provenance:
  source: ccs_archive
  scan_quality: unknown
pdf_url: https://pub-f1430c20cc1c400da542453c56d614c8.r2.dev/liberal-times/liberalism-in-south-asia.pdf
cover_image: "https://pub-f1430c20cc1c400da542453c56d614c8.r2.dev/covers/liberalism-in-south-asia.webp"
rights:
...
- Sharad Joshi opens the issue with a historical essay arguing that Gandhian quasi-anarchism and Congress socialism crowded out a genuine liberal politics in India, producing a 'Nehruvian socialist brand of statism'.

- Ashok V. Desai traces India's post-independence control regime to wartime British economic management and argues the 1990s liberalisation proceeds without any ideological acknowledgment of liberty as a political value.

- Chanaka Amaratunga surveys Sri Lanka's resilient liberal tradition, centred on the Liberal Party's programme of federalism, proportional representation, and ethnic reconciliation.

- Kusum Shrestha reads Nepal's 1990 Constitution as liberal constitutionalism grounded in popular sovereignty and an independent judiciary, while flagging the gap between justiciable rights and aspirational Directive Principles.

- Detmar Doering's brief intellectual history of liberalism traces its lineage from classical antiquity through Locke's Two Treatises of 1689, though only the essay's first page falls within the rendered chunk.

- S. V. Raju, the Freedom First editor and Indian Liberal Group figure, is listed as a contributor whose piece lies in the unrendered pages beyond page twenty.

- The issue is edited by Jurgen Axer for the Friedrich-Naumann-Stiftung's Regional Office South Asia and unites six contributors from India, Sri Lanka, Nepal, and Germany under the theme of liberalism in South Asia.
