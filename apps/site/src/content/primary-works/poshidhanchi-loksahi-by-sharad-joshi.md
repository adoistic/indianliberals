---
id: "poshidhanchi-loksahi-by-sharad-joshi"
title: 
...
provenance: 
  source: "ccs_archive"
  scan_quality: "fair"
  notes: "Imported from indianli_liberals DB (id=45, lang=Marathi). Original PDF filename: PDF_45_uhvawhPoshidhanchi Loksahi - Sharad Joshi.pdf. OCR pages in DB: 179. OCR quality flag: partial. Author (per DB): Sharad Anantrao Joshi."
themes:
  - agriculture
  - democracy
  - economic-freedom
  ...
  - political-economy
ai_key_points:
  - Marathi-language work attributed to Sharad Joshi, the founder of Shetkari Sanghatana and a central figure of the Indian agrarian-liberal tradition.
  - "Title 'Poshidhanchi Loksahi' translates roughly as 'Democracy of the Sustained/Provisioned,' a polemical framing characteristic of Joshi's writing on rural India."
  - "The PDF specifically titled 'poshidhanchi-loksahi' is not present anywhere on the '/Volumes/One Touch/Indian Liberals/' source drive."
  - "The inventory.json maps this id to 'madhyatil-angar-sharad-joshi.pdf,' but that file is the source for the separate 'madhyatil-angar-by-sharad-joshi' entry and is reused as a fallback for several other Joshi ids."
  - No substantive page-level extraction was performed, because reading the wrong PDF would produce a confidently-wrong summary of a different book.
  - "Human review needed: source the correct 'Poshidhanchi Loksahi' scan (or confirm that the work should be folded into another entry) before re-running extraction."
paragraph_ids: []
manifestations: []
language: "mr"
...
authors_resolution:
  ...
  stubs_referenced: []
  collisions_logged: []
pdf_url: https://indianliberals.in/marathi/poshidhanchi-loksahi-sharad-joshi.pdf
---
