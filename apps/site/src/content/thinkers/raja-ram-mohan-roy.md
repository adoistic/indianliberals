...
name:
  canonical: "Raja Ram Mohan Roy"
  full: "Ram Mohan Roy"
  sort: "Roy, Ram Mohan"
  also_known_as: ["Rammohan Roy", "Ram Mohun Roy"]
birth_year: 1772
death_year: 1833
nationality: india
...
> _Drafted bio. Replace with canonical CCS content if available. The site's `/content/ram-mohan-roy/` page is a feature article on press freedom that quotes Roy's 1824 letter to the Governor — not a biographical profile._
